...
<?php
global $amp_conf;
$zts_assets_base = rtrim((string) $amp_conf['AMPWEBROOT'], '/').'/admin/assets/zerotouchsip/js/';
$zts_list_search_js = $zts_assets_base.'zts-list-search.js?v=17.0.0';
$zts_list_pagination_js = $zts_assets_base.'zts-list-pagination.js?v=17.0.1';
?>
<script src="<?php echo htmlspecialchars($zts_list_search_js, ENT_QUOTES, 'UTF-8'); ?>"></script>
<script src="<?php echo htmlspecialchars($zts_list_pagination_js, ENT_QUOTES, 'UTF-8'); ?>"></script>
<script>
(function ($) {
	if (!$) {
		return;
